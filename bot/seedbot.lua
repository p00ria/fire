...
〰〰〰〰〰〰〰
!map [country|province|city]
Returns map and location from [country|province|city]
〰〰〰〰〰〰〰
!info
...
» Only moderators and owner can use kick,ban,unban,newlink,link,setphoto,map,setname,lock,unlock,set rules,set about and settings commands
